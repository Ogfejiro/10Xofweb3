...
const Nav = () => {
  ...
  return (
    <>
      {/* Desktop Nav */}
      <nav
        className="hidden md:block w-full max-w-6xl mx-auto px-8 py-4 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/30 shadow-lg z-50 mt-4"
        data-aos="fade-down"
      >
      ...
      {/* Mobile Nav */}
      <div
        className="md:hidden fixed bottom-4 left-0 right-0 mx-auto w-[90%] max-w-md bg-white/10 backdrop-blur-lg border border-white/30 shadow-lg rounded-2xl px-6 py-3 flex justify-between items-center z-50 overflow-x-hidden"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        <a href="#home" className="hover:text-yellow-400 transition">
